...
- [ ] 02-05-PLAN.md — size-limit budgets in package.json + CI gate in deploy.yml (text <120 KB gz, 3D <450 KB gz, GLB <2.5 MB ignored until Phase 4)
...
| 2. 3D Shell + Asset Pipeline + Capability Gating | 2/5 | In Progress | - |
